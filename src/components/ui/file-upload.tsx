    ...
    <div className="w-full " {...getRootProps()}>
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center">
          <p className="relative z-20 font-sans font-normal text-neutral-400 dark:text-neutral-400 text-sm text-center md:text-base mt-0">
                ...
                >
                  <div className="flex justify-between w-full items-center gap-4">
                    <motion.p
                      ...
                      animate={{ opacity: 1 }}
                      layout
                      className="text-sm lg:text-base text-neutral-700 dark:text-neutral-300 truncate max-w-xs"
                    >
                      {file.name}
                    </motion.p>
                    <motion.p
                  ...
                  {/* <div className="flex text-sm md:flex-row flex-col items-start md:items-center w-full mt-2 justify-between text-neutral-600 dark:text-neutral-400">
                    <motion.p
                      ...
                      animate={{ opacity: 1 }}
                      layout
                      className=" text-xs sm:text-sm lg:text-base px-1 py-0.5 rounded-md bg-gray-100 dark:bg-neutral-800"
                    >
                      {file.type}
                    </motion.p>
